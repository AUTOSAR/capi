...
#ifndef ARA_CRYPTO_CRYP_PUHUA_KEY_SYMMETRIC_H_
#define ARA_CRYPTO_CRYP_PUHUA_KEY_SYMMETRIC_H_
...
/// @brief Symmetric Key interface.
/// @code{.isoft}
/// @interface PKeySymmetric_Base
/// @AUTOSAR_SWS {SWS_CRYPT_23800}
/// @tracestatus={draft}
/// @uptrace={RS_CRYPTO_02001}
/// @uptrace={RS_CRYPTO_02403}
/// @interface_level=unit
/// @trace_id_ad=AD_CRYPTO_01373
/// @trace_id_dd=DD_CRYPTO_03596
/// @needwork = ad
/// @endcode
class PKeySymmetric_Base : public SymmetricKey
{
public:
    /// @brief Default virtual destructor
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01374
    /// @trace_id_dd=DD_CRYPTO_03597
    /// @needwork = ad
    /// @endcode
    ~PKeySymmetric_Base() noexcept override = default;
    /// @brief Default constructor
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01375
    /// @trace_id_dd=DD_CRYPTO_03598
    /// @needwork = ad
    /// @endcode
    PKeySymmetric_Base() noexcept;
    /// @brief Default copy constructor
    /// @param other Another object instance of this class
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01376
    /// @trace_id_dd=DD_CRYPTO_03599
    /// @needwork = ad
    /// @endcode
    PKeySymmetric_Base(PKeySymmetric_Base const &other) = delete;
    /// @brief Default move constructor
    /// @param other Another object instance of this class
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01377
    /// @trace_id_dd=DD_CRYPTO_03600
    /// @needwork = ad
    /// @endcode
    PKeySymmetric_Base(PKeySymmetric_Base &&other) = delete;
    /// @brief Default copy assignment function
    /// @param other Another object instance of this class
    /// @returns *this
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01378
    /// @trace_id_dd=DD_CRYPTO_03601
    /// @needwork = ad
    /// @endcode
    PKeySymmetric_Base &operator=(PKeySymmetric_Base const &other) = delete;
    /// @brief Default move assignment function
    /// @param other Another object instance of this class
    /// @returns *this
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01379
    /// @trace_id_dd=DD_CRYPTO_03602
    /// @needwork = ad
    /// @endcode
    PKeySymmetric_Base &operator=(PKeySymmetric_Base &&other) = delete;
...
public:  // CryptoObject interface
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01380
    /// @trace_id_dd=DD_CRYPTO_03603
    /// @needwork = ad
    /// @endcode
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01381
    /// @trace_id_dd=DD_CRYPTO_03604
    /// @needwork = ad
    /// @endcode
    ...
    /// @brief Returns the actual size of the object payload.
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01382
    /// @trace_id_dd=DD_CRYPTO_03605
    /// @needwork = ad
    /// @endcode
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01383
    /// @trace_id_dd=DD_CRYPTO_03606
    /// @needwork = ad
    /// @endcode
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01384
    /// @trace_id_dd=DD_CRYPTO_03607
    /// @needwork = ad
    /// @endcode
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01385
    /// @trace_id_dd=DD_CRYPTO_03608
    /// @needwork = ad
    /// @endcode
    ...
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01386
    /// @trace_id_dd=DD_CRYPTO_03609
    /// @needwork = ad
    /// @endcode
...
public:  // RestrictedUseObject interface
    ...
    /// @tracestatus={draft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01387
    /// @trace_id_dd=DD_CRYPTO_03610
    /// @needwork = ad
    /// @endcode
...
public:
    ...
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01388
    /// @trace_id_dd=DD_CRYPTO_03611
    /// @needwork = ad
    /// @endcode
    virtual uint8_t *GetKeySymmetric() const noexcept { return nullptr; }
    /// @brief Set usage
    /// @param usage Scope of use. Alias to the container type for bit-flags of allowed usages of the object.
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01389
    /// @trace_id_dd=DD_CRYPTO_03612
    /// @needwork = ad
    /// @endcode
    ...
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01390
    /// @trace_id_dd=DD_CRYPTO_03613
    /// @needwork = ad
    /// @endcode
    ...
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_CRYPTO_01391
    /// @trace_id_dd=DD_CRYPTO_03614
    /// @needwork = ad
    /// @endcode
...
#endif  // ARA_CRYPTO_CRYP_PUHUA_KEY_SYMMETRIC_H_
