...
/// File description:
/// ----------------
/// @file       isoft_ctx_key_decapsulator_private.cpp
...
/// @returns
/// @throws
PCtxKeyDecapsulatorPrivate::PCtxKeyDecapsulatorPrivate(PCryptoProvider &cryptoProvider) noexcept
    : KeyDecapsulatorPrivateCtx{}  // NOLINT
...
inline CryptoProvider &PCtxKeyDecapsulatorPrivate::MyProvider() const noexcept { return cryptoProvider_; }
// PRQA L:QAC
