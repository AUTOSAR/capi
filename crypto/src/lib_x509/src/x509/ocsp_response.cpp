...
std::uint32_t OcspResponse::Version() const noexcept { return 0U; }
...
/// type
/// @threadsafety={Thread-safe}
ara::core::Result< ara::core::Vector< ara::core::Byte > > OcspResponse::ExportPublicly(FormatId formatId) const noexcept
{
    std::ignore = formatId;
