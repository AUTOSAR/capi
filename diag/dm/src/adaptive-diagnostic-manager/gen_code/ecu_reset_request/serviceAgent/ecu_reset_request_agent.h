...
/// @brief      This file provides the definition of the EcuResetRequestAgent interface class.
/// @details
/// @date       2021-11-23
/// @author     jiawei
/// @version    1.2.0
...
#ifndef SERVICEAGENT_ECURESETREQUESTAGENT_H_
#define SERVICEAGENT_ECURESETREQUESTAGENT_H_
...
{
public:
    explicit EcuResetRequestAgent(uint16_t const& instanceId, uint32_t const& serviceInstanceId);
    ...
    ara::core::Result< std::uint32_t > GetLastResetCause() noexcept;
    ...
    ara::core::Future< void > EnableRapidShutdown(
        bool enable,
    ...
    ara::core::Future< void > RequestReset(std::uint32_t resetType,
    ...
    void ExecuteReset(MetaInfoMap metaInfo) noexcept;
...
#endif  // SERVICEAGENT_ECURESETREQUESTAGENT_H_