...
#ifndef SERVICEAGENT_ECURESETREQUESTPROXY_H_
#define SERVICEAGENT_ECURESETREQUESTPROXY_H_
...
class EcuResetRequestProxy : public BussinessClientProxy
{
public:
    explicit EcuResetRequestProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId);
...
#endif  // SERVICEAGENT_ECURESETREQUESTPROXY_H_