...
RawDataElementProxy::RawDataElementProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId)
...
ara::core::Future< ara::core::Vector< std::uint8_t > > RawDataElementProxy::Read(
