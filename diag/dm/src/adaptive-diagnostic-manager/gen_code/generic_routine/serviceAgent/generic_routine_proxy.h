...
#ifndef __SERVICEAGENT_GENERICROUTINEPROXY_H_
#define __SERVICEAGENT_GENERICROUTINEPROXY_H_
...
class GenericRoutineProxy : public BussinessClientProxy
{
public:
    explicit GenericRoutineProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId);
...
#endif  // __SERVICEAGENT_GENERICROUTINEPROXY_H_