...
#ifndef __SERVICEAGENT_UPLOADPROXY_H_
#define __SERVICEAGENT_UPLOADPROXY_H_
...
class UploadServiceProxy : public BussinessClientProxy
{
public:
    explicit UploadServiceProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId);
...
#endif  // __SERVICEAGENT_UPLOADPROXY_H_