...
GenericDataIdentifierProxy::GenericDataIdentifierProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId)
...
ara::core::Future< ara::core::Vector< std::uint8_t > > GenericDataIdentifierProxy::Read(
    std::uint16_t dataIdentifier, MetaInfoMap const& metaInfo, std::shared_ptr< CancellationEvent >& cancelEventPtr)
{
    ...
    ara::core::Future< ara::core::Vector< std::uint8_t > > result{AsyncCallFunc< ara::core::Vector< std::uint8_t > >(
        kFunc_Id, s_CallId, cancelEventPtr, dataIdentifier, metaInfo)};

    return result;
}

ara::core::Future< void > GenericDataIdentifierProxy::Write(std::uint16_t dataIdentifier,
                                                            ...
                                                            std::shared_ptr< CancellationEvent >& cancelEventPtr)
{
    ...
    ara::core::Future< void > result{
        AsyncCallFunc< void >(kFunc_Id, s_CallId, cancelEventPtr, dataIdentifier, std::move(requestData), metaInfo)};
