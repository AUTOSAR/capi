...
#ifndef __GEN_SERVICEAGENT_RAWROUTINEPEOXY__
#define __GEN_SERVICEAGENT_RAWROUTINEPEOXY__
...
class RawRoutineProxy : public BussinessClientProxy
{
public:
...
public:
    explicit RawRoutineProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId);
...
#endif  // __GEN_SERVICEAGENT_RAWROUTINEPEOXY__