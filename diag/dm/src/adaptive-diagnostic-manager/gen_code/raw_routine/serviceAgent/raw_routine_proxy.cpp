...
RawRoutineProxy::RawRoutineProxy(uint16_t const& instanceId, uint32_t const& serviceInstanceId)
...
ara::core::Future< std::vector< std::uint8_t > > RawRoutineProxy::Start(
    ...
    std::shared_ptr< CancellationEvent >& cancellationEventPtr) noexcept
{
    ...
    ara::core::Future< std::vector< std::uint8_t > > result{
        AsyncCallFunc< std::vector< std::uint8_t > >(kFunc_Id, s_CallId, cancellationEventPtr, requestData, metaInfo)};

    return result;
}

ara::core::Future< std::vector< std::uint8_t > > RawRoutineProxy::Stop(
    std::vector< std::uint8_t >& requestData,
    MetaInfoMap& metaInfo,
    std::shared_ptr< CancellationEvent >& cancellationEventPtr) noexcept
{
...
ara::core::Future< std::vector< std::uint8_t > > RawRoutineProxy::RequestResults(
    std::vector< std::uint8_t >& requestData,
    MetaInfoMap& metaInfo,
    std::shared_ptr< CancellationEvent >& cancellationEventPtr) noexcept
{
