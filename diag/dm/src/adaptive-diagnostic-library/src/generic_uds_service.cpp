...
/// @brief      This file provides the implementation of GenericUDSService.
/// @details
/// @date       2022-07-25
/// @author     gaohuiming
/// @version    1.2.0
...
#include "gen_code/generic_uds_service/apiAgent/generic_uds_service_agent.h"
#include "resolve.h"
#include "utility.h"
namespace ara {
namespace diag {
...
GenericUDSService::GenericUDSService(ara::core::InstanceSpecifier const &specifier,  // NOLINT
...
ara::core::Result< void > GenericUDSService::Offer()
{
    ...
    skeleton_ = std::make_shared< isoft::dm::dis::GenericUdsServiceAgent >(retrieveResult.Value().serviceInstanceId);
...
void GenericUDSService::StopOffer()
{
    if (skeleton_ != nullptr) {
        skeleton_.reset();
    }
