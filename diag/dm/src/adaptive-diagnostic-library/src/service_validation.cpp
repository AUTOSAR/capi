...
/// @brief      This file provides the implementation of ServiceValidation.
/// @details
/// @date       2022-07-25
/// @author     gaohuiming
/// @version    1.2.0
...
#include "ara/diag/service_validation.h"

#include <ara/core/instance_specifier.h>

#include "ara/diag/diag_error_domain.h"
#include "gen_code/service_validation/apiAgent/service_validation_agent.h"
#include "resolve.h"
#include "utility.h"
namespace ara {
namespace diag {
...
ServiceValidation::ServiceValidation(ara::core::InstanceSpecifier const &specifier)  // NOLINT
    : specifier_{specifier}, skeleton_{}                                             // NOLINT
{
}
...
/// export_level=/Diagnostics
/// @endcode
/// @returns Returns nothing or an error: kNotOffered, kGenericError,
/// kAlreadyOffered
/// @throws on overflow
///
/// @traceid{SWS_DM_00776}@tracestatus{draft}
ara::core::Result< void > ServiceValidation::Offer()
{
    ...
    skeleton_ = std::make_shared< isoft::dm::dis::ServiceValidationAgent >(retrieveResult.Value().serviceInstanceId);
...
void ServiceValidation::StopOffer()
{
    if (skeleton_ != nullptr) {
        skeleton_.reset();
    }
