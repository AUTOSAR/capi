...
/// @brief      This file provides the implementation of GenericRoutine.
/// @details
/// @date       2022-07-25
/// @author     gaohuiming
/// @version    1.2.0
...
#include "gen_code/generic_routine/apiAgent/generic_routine_agent.h"
#include "resolve.h"
#include "utility.h"
...
GenericRoutine::GenericRoutine(ara::core::InstanceSpecifier const &specifier,  // NOLINT
...
ara::core::Result< void > GenericRoutine::Offer()
{
    ...
    skeleton_ = std::make_shared< isoft::dm::dis::GenericRoutineAgent >(retrieveResult.Value().serviceInstanceId);
