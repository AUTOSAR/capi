...
#include "gen_code/upload/apiAgent/upload_agent.h"
#include "resolve.h"
#include "utility.h"
...
UploadService::UploadService(ara::core::InstanceSpecifier const &specifier,  // NOLINT
...
ara::core::Result< void > UploadService::Offer()
{
    ...
    skeleton_ = std::make_shared< isoft::dm::dis::UploadServiceAgent >(retrieveResult.Value().serviceInstanceId);
