...
/// File description:
/// ----------------
/// @file       raw_routine.cpp
/// @brief      This file provides the implementation of RawRoutine.
/// @details
/// @date       2022-08-15
/// @author     gaohuiming
/// @version    1.2.0
...
#include "gen_code/raw_routine/apiAgent/raw_routine_agent.h"
#include "resolve.h"
#include "utility.h"
namespace ara {
namespace diag {
...
/// @throws on overflow
RawRoutine::RawRoutine(ara::core::InstanceSpecifier specifier, ReentrancyType reentrancyType)
...
/// @return Result
/// @throws on overflow
ara::core::Result< void > RawRoutine::Offer()
{
    ...
    skeleton_
        = std::make_shared< isoft::dm::dis::RawRoutineAgent >(std::move(retrieveResult).Value().serviceInstanceId);
