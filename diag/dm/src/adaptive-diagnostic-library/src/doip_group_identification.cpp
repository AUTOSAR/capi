...
/// File description:
/// ----------------
/// @file       doip_group_identification.cpp
/// @brief      This file provides the implementation of DoIPGroupIdentification.
/// @details
/// @date       2022-08-22
/// @author     kai.ju
/// @version    1.2.0
...
#include "ara/diag/doip_group_identification.h"

#include <ara/core/instance_specifier.h>

#include "ara/diag/diag_error_domain.h"
#include "gen_code/group_identification/clientAgent/group_identification_agent.h"
#include "resolve.h"
#include "utility.h"
...
DoIPGroupIdentification::DoIPGroupIdentification(ara::core::InstanceSpecifier const &specifier,  /// NOLINT
...
ara::core::Result< void > DoIPGroupIdentification::Offer() noexcept
{
    ...
    skeleton_ = std::make_shared< isoft::dm::dis::GroupIdentificationAgent >(result.Value().serviceInstanceId);
...
void DoIPGroupIdentification::StopOffer() noexcept
{
    if (skeleton_ != nullptr) {
        skeleton_.reset();
    }
