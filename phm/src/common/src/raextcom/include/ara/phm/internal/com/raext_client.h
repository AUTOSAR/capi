...
/// ----------------
/// @file       raext_client.h
/// @brief      used by RecoveryAction to send request.
/// @details
/// @date       2024-06-05
/// @author     wangyanlong
/// @version    1.2.0
...
/// @unit_description=used by RecoveryAction to send request.
...
#ifndef ARA_PHM_INTERNAL_RAEXTCOM_CLIENT_H_
#define ARA_PHM_INTERNAL_RAEXTCOM_CLIENT_H_

#include <memory>

#include "ara/phm/internal/com/base_client.h"
#include "ara/phm/internal/com/raext_message.h"
...
public:
    ...
    static std::shared_ptr< Client > GetInstanceShared()
    {
        ...
        return s_Instance;  // TODO(wangyanlong): What would happen if std:move is used here
    }
    ...
    /// @trace_id_sr=SR_PHM_01027
    /// @needwork = ad
    SupervisionStatus GetGlobalSupervisionStatus(ara::core::String const& instance) noexcept;
...
private:
    ...
    /// @trace_id_sr=SR_PHM_01027
    /// @needwork = dda
    Client() noexcept : BaseClient{GetIpcPhmRaExtCmClient()}, messageSerializer_{} {};
...
#endif  // ARA_PHM_INTERNAL_RAEXTCOM_CLIENT_H_
