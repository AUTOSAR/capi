...
#ifndef ARA_PHM_INTERNAL_RAEXTCOM_SERVER_H_
#define ARA_PHM_INTERNAL_RAEXTCOM_SERVER_H_
...
public:
    ...
    /// @trace_id_sr=SR_PHM_01027
    /// @needwork = no
    using UserHandler = std::function< void(ara::core::String const& metaModelIdentifier, EventType eventType) >;
...
private:
    ...
    explicit Server(UserHandler userHandler) noexcept
        : BaseServer{GetIpcPhmRaExtCmServer()}, userHandler_{std::move(userHandler)}, messageSerializer_{} {};
...
#endif  // ARA_PHM_INTERNAL_RAEXTCOM_SERVER_H_
