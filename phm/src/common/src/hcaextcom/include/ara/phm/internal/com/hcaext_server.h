...
/// File description:
/// ----------------
/// @file       hcaext_server.h
/// @brief      used by SupervisionManager to receive request(Offer/StopOffer).
/// @details
/// @date       2024-06-05
/// @author     wangyanlong
/// @version    1.2.0
...
/// @unit_description=used by SupervisionManager to receive request(Offer/StopOffer).
...
#ifndef ARA_PHM_INTERNAL_HCAEXTCOM_SERVER_H_
#define ARA_PHM_INTERNAL_HCAEXTCOM_SERVER_H_
...
/// @brief Server of raextcom.
/// @trace_id_sr=SR_PHM_01028
/// @needwork = ad
class Server : public BaseServer
{
public:
    /// @brief Definition of a function, it defines user handler to process resuest from SM.
    /// @trace_id_sr=SR_PHM_01028
    /// @needwork = no
    using UserHandler = std::function< void(ara::core::String const& instance, EventType eventType) >;
    ...
    {
        static std::unique_ptr< Server > s_Instance{};
...
private:
    ...
    explicit Server(UserHandler userHandler) noexcept
        : BaseServer{GetIpcPhmHcaExtCmServer()}, userHandler_{std::move(userHandler)}, messageSerializer_{} {};
...
#endif  // ARA_PHM_INTERNAL_HCAEXTCOM_SERVER_H_
