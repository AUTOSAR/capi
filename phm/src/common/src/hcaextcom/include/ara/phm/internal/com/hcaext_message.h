...
#ifndef ARA_PHM_INTERNAL_HCAEXTCOM_MESSAGE_H_
#define ARA_PHM_INTERNAL_HCAEXTCOM_MESSAGE_H_
...
/// @brief returns client addr of hcaextcom.
/// @return client addr of hcaextcom.
/// @trace_id_sr=SR_PHM_01028
/// @needwork = ad
inline ara::core::String GetIpcPhmHcaExtCmClient() noexcept { return ara::core::String{"phmd/haec"}; }

/// @brief returns server addr of hcaextcom.
/// @return server addr of hcaextcom.
/// @trace_id_sr=SR_PHM_01028
/// @needwork = ad
inline ara::core::String GetIpcPhmHcaExtCmServer() noexcept { return ara::core::String{"haec"}; }
...
#endif  // ARA_PHM_INTERNAL_HCAEXTCOM_MESSAGE_H_