...
"""
Rectangular vector implementation type.
"""
...
class RectangularVectorImplDataType(ImplDataType):
    """Describes a rectangular two-dimensional vector data-type
    (C++ style declaration)"""
    def __init__(self, name, type_emitter, element_data_type: ImplDataType,
        ...
        super().__init__(name, type_emitter)
