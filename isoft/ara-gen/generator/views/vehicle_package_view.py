...
"""
import hashlib
from generator.intermediate_model.vehicle_package.vehicle_package \
    import VehiclePackage
from generator.views.view import View
from generator.views.view_factory import ViewFactory

class VehiclePackageView(View):
    """Specialized View of a SoftwarePackage."""

    def __init__(self, vehiclePackage: VehiclePackage) -> None:
        self._vehiclePackage = vehiclePackage
        name = self._vehiclePackage.name
