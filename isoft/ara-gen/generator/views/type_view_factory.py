...
from generator.views.impltype_view import StructImplTypeView, \
    ...
    VectorImplTypeView, StringImplTypeView, ArrayImplTypeView, VariantImplTypeView, FixedStringImplTypeView
...
class TypeViewFactory(object):
    ...
    @staticmethod
    def create_fixed_string_view(type):
        return FixedStringImplTypeView(type)
