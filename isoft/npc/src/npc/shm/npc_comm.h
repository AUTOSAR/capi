 ...
 */
    npc_message_t* npc_comm_create_message(npc_comm_t* c, npc_serv_t serv, npc_inst_t inst, int usage);
 ...
 */
    npc_comif_t* npc_comif_create(
        npc_comm_t* c, npc_comif_ops_t* ops, void* ctx, const char* path, const npc_shmz_attr_t* attr, int flags, ...);
