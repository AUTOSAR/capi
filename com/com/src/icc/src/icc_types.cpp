...
#include "ara/com/internal/icc/icc_types.h"
...
ara::core::String& ToString(ara::core::String& r, icc_message_t const& m) noexcept
{
    ...
    switch (m.hdr.type) {
        case Message::kMessageTypeNotification: {
            return internal::format::FormatToString(r, GenK2V0("service", m.hdr.serv), GenK2V("instance", m.inst),
                                                    GenK2V("s->notification", m.hdr.method),
                                                    GenK2V("session", m.hdr.session), GenK2V("length", m.hdr.len));
        } break;
        case Message::kMessageTypeRequest:
        case Message::kMessageTypeRequestNoReturn: {
            return internal::format::FormatToString(r, GenK2V0("service", m.hdr.serv), GenK2V("instance", m.inst),
                                                    GenK2V("p->request", m.hdr.method),
                                                    GenK2V("session", m.hdr.session));
        } break;
        case Message::kMessageTypeResponse: {
            return internal::format::FormatToString(r, GenK2V0("service", m.hdr.serv), GenK2V("instance", m.inst),
                                                    GenK2V("s->response", m.hdr.method),
                                                    GenK2V("session", m.hdr.session));
        } break;
        case Message::kMessageTypeError: {
            return internal::format::FormatToString(r, GenK2V0("service", m.hdr.serv), GenK2V("instance", m.inst),
        ...
        default: {
            return internal::format::FormatToString(r, GenK2V0("service", m.hdr.serv), GenK2V("instance", m.inst),
                                                    GenK2V("method", m.hdr.method), GenK2V("session", m.hdr.session),
                                                    GenK2V("type(unknown)", m.hdr.type));
        } break;
    }
#endif
}
