...
#ifndef __COM_ICC_TYPES_H
#define __COM_ICC_TYPES_H
...
using ServiceId = icc_serv_t;
/// @brief Type alias -- instance identifier
using InstanceId = icc_inst_t;
/// @brief Type alias -- service major version
using ServiceVersionMajor = icc_version_t;
/// @brief Type alias -- service minor version
using ServiceVersionMinor = icc_versmin_t;
...
using EventGroupId = icc_gid_t;
/// @brief Type alias -- event identifier
using EventId = icc_eid_t;
/// @brief Type alias -- method identifier
using MethodId = icc_method_t;
...
ara::core::String& ToString(ara::core::String& r, icc_message_t const& m) noexcept;
}  // namespace types
...
struct Message
{
    ...
    using ClientId = icc_cid_t;
    /// @brief Type alias -- session identifier
    using SessionId = icc_session_t;
    ...
    static constexpr ServiceId kServiceIdAny{ICC_SERVICE_ANY};
    ...
    static constexpr InstanceId kInstanceIdAny{ICC_INSTANCE_ANY};

    /// @brief Constant -- service major version: default
    static constexpr MajorVersion kMajorVersionDefault{ICC_DEFAULT_MAJOR};
    /// @brief Constant -- service major version: any
    static constexpr MajorVersion kMajorVersionAny{ICC_MAJOR_ANY};
    ...
    static constexpr MinorVersion kMinorVersionAny{ICC_MINOR_ANY};
    ...
    static constexpr MethodId kMethodIdAny{ICC_METHOD_ANY};
    ...
    static constexpr ProtocolVersion kProtocolVersionDefault{ICC_PROTOCOL_VERSION};
    ...
    static constexpr MessageType kMessageTypeRequest{ICC_MT_REQUEST};
    /// @brief Constant -- message type: 0X01 REQUEST_NO_RETURN A fire&forget request
    static constexpr MessageType kMessageTypeRequestNoReturn{ICC_MT_REQUEST_NO_RETURN};
    /// @brief Constant -- message type: 0X02 NOTIFICATION A request of a notification/event callback expecting no response
    static constexpr MessageType kMessageTypeNotification{ICC_MT_NOTIFICATION};
    /// @brief Constant -- message type: 0X80 RESPONSE The response message
    static constexpr MessageType kMessageTypeResponse{ICC_MT_RESPONSE};
    /// @brief Constant -- message type: 0X81 ERROR The response containing an error
    static constexpr MessageType kMessageTypeError{ICC_MT_ERROR};
    ...
    static constexpr TransportProtocol kTransportProtocolUnknown{ICC_RT_UNKNOWN};
    /// @brief Constant -- transport protocol: TCP
    static constexpr TransportProtocol kTransportProtocolTCP{ICC_RT_RELIABLE};
    /// @brief Constant -- transport protocol: UDP
    static constexpr TransportProtocol kTransportProtocolUDP{ICC_RT_UNRELIABLE};
    /// @brief Constant -- transport protocol: TCP/UDP
    static constexpr TransportProtocol kTransportProtocolBoth{ICC_RT_BOTH};
...
struct PServiceInfo : ServiceInfo
{
    ...
    struct SdServerConfig
    {
        ...
        /// @brief Receive multicast request response allowed delay
...
struct PGroupInfo : GroupInfo
{
    ...
    /// @brief Event group multicast threshold (same as unicast if no multicast address)
...
struct EventInfo
{
    ...
    /// @brief Event interval time (UDP, s)
...
struct MethodInfo
{
    ...
    /// @brief Method request interval time (UDP, s)
    double separationTimeRequest{1.0};  // NOLINT -- default value > naming convention
    /// @brief Method response interval time (UDP, s)
...
template <>
struct Formatter< ara::core::String, icc_message_t >
{
    /// @brief Convert to string
    /// @param[in, out] r String reference
    /// @param[in] m Message
    /// @return String reference
    static ara::core::String& ToString(ara::core::String& r, icc_message_t const& m) noexcept
    {
        return ara::com::internal::icc::types::ToString(r, m);
    }
};
}  // namespace format
}  // namespace internal
