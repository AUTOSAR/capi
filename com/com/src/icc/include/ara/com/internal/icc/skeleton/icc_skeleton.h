...
#ifndef __COM_ICC_SKELETON_H
#define __COM_ICC_SKELETON_H
...
class IccSkeleton : public ara::com::internal::skeleton::BindSkeleton
{
public:
    ...
    static std::unique_ptr< IccSkeleton > Create(Skeleton& skeleton,
                                                 ara::com::InstanceIdentifier const& instanceIdentifier) noexcept
    {
        ...
        ICC_ASSERT(serviceInfo != nullptr && serviceInfo->IsProvided(), -__LINE__);
        return std::make_unique< IccSkeleton >(static_cast< PServiceInfo& >(*serviceInfo), bindRuntime, skeleton);
    }
    ...
    {
        auto event{std::make_shared< IccEvent< IccSkeleton, Desc, typename T::SampleType > >(*this)};
    ...
    void Create(R (Skeleton::*f)(Args...)) noexcept
    {
        ...
        auto method{std::make_shared< IccMethod< IccSkeleton, Desc, Callback > >(
    ...
    {
        auto field{std::make_shared< IccNField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
    ...
    {
        auto field{std::make_shared< IccSField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
    ...
    {
        auto field{std::make_shared< IccGField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
    ...
    {
        auto field{std::make_shared< IccNSField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterSetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterSetReceiver(); });
    ...
    {
        auto field{std::make_shared< IccNGField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterGetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterGetReceiver(); });
    ...
    {
        auto field{std::make_shared< IccSGField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
        beforeOffer_.emplace_back([field]() { return field->RegisterSetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterSetReceiver(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterGetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterGetReceiver(); });
    ...
    {
        auto field{std::make_shared< IccNSGField< IccSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterSetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterSetReceiver(); });
    ...
    /// @param[in] skeleton Service skeleton
    IccSkeleton(PServiceInfo const& pServiceInfo, IccRuntime& bindRuntime, Skeleton& skeleton) noexcept
    ...
    /// @param other
    IccSkeleton(IccSkeleton const& other) noexcept = default;
    /// @brief Move constructor
    /// @param other
    IccSkeleton(IccSkeleton&& other) noexcept = default;
    /// @brief Copy assignment operator
    /// @param other
    /// @return IccSkeleton
    IccSkeleton& operator=(IccSkeleton const& other) noexcept = default;
    /// @brief Move assignment operator
    /// @param other
    /// @return IccSkeleton
    IccSkeleton& operator=(IccSkeleton&& other) noexcept = default;
    /// @brief Offer service
    ...
    {
        ICC_ASSERT((**skeleton_).GetMethodCallProcessingMode() == MethodCallProcessingMode::kPoll,
...
private:
    ...
    /// @brief Mutex -- for pending method calls
...
{
    return IccSkeleton< ServiceDesc, ServiceSkeleton >::Create(skeleton, instanceIdentifier);
}
/// @brief Skeleton mapper implementation type
/// @tparam SkeletonImpl Skeleton implementation type
template < typename SkeletonImpl >
class IccSkeletonMapper : public IccRuntime::SkeletonMapperBase
{
public:
