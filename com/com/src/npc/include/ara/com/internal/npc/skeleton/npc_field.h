...
#ifndef __COM_NPC_SKELETON_FIELD_H
#define __COM_NPC_SKELETON_FIELD_H
...
using NpcNField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kN >;
/// @brief Type alias -- settable field
/// @tparam Owner Service element owner
/// @tparam Desc Description info
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NpcSField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kS >;
/// @brief Type alias -- gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description info
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NpcGField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kG >;
/// @brief Type alias -- notifiable/settable field
/// @tparam Owner Service element owner
/// @tparam Desc Description info
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NpcNSField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kNS >;
/// @brief Type alias -- notifiable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description info
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NpcNGField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kNG >;
/// @brief Type alias -- settable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description info
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NpcSGField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kSG >;
/// @brief Type alias -- notifiable/settable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description info
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NpcNSGField = NpcField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kNSG >;
...
public:
    ...
    /// @brief Type alias -- field data type
    using FieldType = typename FieldBase::FieldType;
    /// @brief Type alias -- set method handling signature
...
private:
    ...
    NpcMethod< Owner, ToSetMethodDesc, std::function< SetSignature > > setMethod_;
    /// @brief Set handler
...
public:
    ...
    /// @brief Type alias -- field data type
    using FieldType = typename FieldBase::FieldType;
    /// @brief Type alias -- get method handling signature
...
private:
    ...
    NpcMethod< Owner, ToGetMethodDesc, std::function< GetSignature > > getMethod_;
    /// @brief Get handler
