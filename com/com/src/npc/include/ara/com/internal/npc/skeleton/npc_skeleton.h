...
#ifndef __COM_NPC_SKELETON_H
#define __COM_NPC_SKELETON_H
...
class NpcSkeleton : public ara::com::internal::skeleton::BindSkeleton
{
public:
    ...
    static std::unique_ptr< NpcSkeleton > Create(Skeleton& skeleton,
                                                 ara::com::InstanceIdentifier const& instanceIdentifier) noexcept
    {
        ...
        NPC_ASSERT(serviceInfo != nullptr && serviceInfo->IsProvided(), -__LINE__);
        return std::make_unique< NpcSkeleton >(static_cast< PServiceInfo& >(*serviceInfo), bindRuntime, skeleton);
    }
    ...
    {
        auto event{std::make_shared< NpcEvent< NpcSkeleton, Desc, typename T::SampleType > >(*this)};
    ...
    void Create(R (Skeleton::*f)(Args...)) noexcept
    {
        ...
        auto method{std::make_shared< NpcMethod< NpcSkeleton, Desc, Callback > >(
    ...
    {
        auto field{std::make_shared< NpcNField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        return field;
    }
    ...
    {
        auto field{std::make_shared< NpcSField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
    ...
    {
        auto field{std::make_shared< NpcGField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
    ...
    {
        auto field{std::make_shared< NpcNSField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterSetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterSetReceiver(); });
    ...
    {
        auto field{std::make_shared< NpcNGField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterGetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterGetReceiver(); });
    ...
    {
        auto field{std::make_shared< NpcSGField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
        beforeOffer_.emplace_back([field]() { return field->RegisterSetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterSetReceiver(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterGetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterGetReceiver(); });
    ...
    {
        auto field{std::make_shared< NpcNSGField< NpcSkeleton, Desc, typename T::FieldType > >(*this)};
        afterOffer_.emplace_back([field]() { return field->OfferNotification(); });
        beforeStopOffer_.emplace_back([field]() { return field->StopOfferNotification(); });
        beforeOffer_.emplace_back([field]() { return field->RegisterSetReceiver(); });
        afterStopOffer_.emplace_back([field]() { return field->UnregisterSetReceiver(); });
    ...
    /// @param[in] skeleton Service skeleton
    NpcSkeleton(PServiceInfo const& pServiceInfo, NpcRuntime& bindRuntime, Skeleton& skeleton) noexcept
    ...
    /// @brief Destructor
    ~NpcSkeleton() noexcept override
    {
        ComLogTrace("destroy bind skeleton", GenArg(pServiceInfo_));
        MonitorTrace(runtime::GetInstance(), trace::userdefine::kServiceOffered, trace::ServiceType::kSkeleton,
    ...
    /// @param other
    NpcSkeleton(NpcSkeleton const& other) noexcept = default;
    /// @brief Move constructor
    /// @param other
    NpcSkeleton(NpcSkeleton&& other) noexcept = default;
    /// @brief Copy assignment operator
    /// @param other
    /// @return NpcSkeleton
    NpcSkeleton& operator=(NpcSkeleton const& other) noexcept = default;
    /// @brief Move assignment operator
    /// @param other
    /// @return NpcSkeleton
    NpcSkeleton& operator=(NpcSkeleton&& other) noexcept = default;
    /// @brief Offer service
    ...
    {
        NPC_ASSERT((**skeleton_).GetMethodCallProcessingMode() == MethodCallProcessingMode::kPoll,
...
{
    return NpcSkeleton< ServiceDesc, ServiceSkeleton >::Create(skeleton, instanceIdentifier);
}
/// @brief Skeleton mapper implementation type
/// @tparam SkeletonImpl Skeleton implementation type
template < typename SkeletonImpl >
class NpcSkeletonMapper : public NpcRuntime::SkeletonMapperBase
{
public:
