...
#ifndef __COM_NSOMEIP_SKELETON_FIELD_H
#define __COM_NSOMEIP_SKELETON_FIELD_H
...
using NSomeipNField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kN >;
/// @brief Type alias -- settable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipSField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kS >;
/// @brief Type alias -- gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipGField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kG >;
/// @brief Type alias -- notifiable/settable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipNSField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kNS >;
/// @brief Type alias -- notifiable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipNGField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kNG >;
/// @brief Type alias -- settable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipSGField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kSG >;
/// @brief Type alias -- notifiable/settable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipNSGField = NSomeipField< Owner, Desc, T, ara::com::internal::skeleton::FieldMode::kNSG >;
...
class NFieldImpl
    ...
    , public NSomeipEvent< Owner, Desc, T >
{
public:
    ...
    using EventImpl = NSomeipEvent< Owner, Desc, T >;
...
public:
    ...
    /// @brief Type alias -- field data type
    using FieldType = typename FieldBase::FieldType;
    /// @brief Type alias -- handle set method signature
    ...
    /// @brief Register set method receiver -- called before service provision
    ...
    /// @brief Unregister set method receiver -- called after stopping service provision
    /// @return Result object -- void/value or error
...
private:
    ...
    NSomeipMethod< Owner, ToSetMethodDesc, std::function< SetSignature > > setMethod_;
    /// @brief Set handler
...
public:
    ...
    /// @brief Type alias -- field data type
    using FieldType = typename FieldBase::FieldType;
    /// @brief Type alias -- handle get method signature
    ...
    /// @brief Register get method receiver -- called before service provision
    /// @return Result object -- void/value or error
    ara::core::Result< void > RegisterGetReceiver() noexcept { return getMethod_.RegisterReceiver(); }
    /// @brief Unregister get method receiver -- called after stopping service provision
    /// @return Result object -- void/value or error
...
private:
    ...
    NSomeipMethod< Owner, ToGetMethodDesc, std::function< GetSignature > > getMethod_;
    /// @brief Get handler
...
public:
    /// @brief Constructor
    /// @param[in] owner Service element owner
    explicit NSomeipField(Owner& owner) noexcept
    ...
    /// @brief Destructor
    ~NSomeipField() noexcept override { ComLogTrace(""); }
    /// @brief Copy constructor
    /// @param other
    NSomeipField(NSomeipField const& other) noexcept = default;
    /// @brief Move constructor
    /// @param other
    NSomeipField(NSomeipField&& other) noexcept = default;
    /// @brief Copy assignment operator
    /// @param other
    /// @return NSomeipField
    NSomeipField& operator=(NSomeipField const& other) noexcept = default;
    /// @brief Move assignment operator
    /// @param other
    /// @return NSomeipField
    NSomeipField& operator=(NSomeipField&& other) noexcept = default;
};
}  // namespace skeleton
}  // namespace nsomeip
}  // namespace internal
