...
#ifndef __COM_NSOMEIP_PROXY_FIELD_H
#define __COM_NSOMEIP_PROXY_FIELD_H
...
using NSomeipNField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kN >;
/// @brief Type alias -- settable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipSField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kS >;
/// @brief Type alias -- gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipGField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kG >;
/// @brief Type alias -- notifiable/settable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipNSField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kNS >;
/// @brief Type alias -- notifiable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipNGField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kNG >;
/// @brief Type alias -- settable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipSGField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kSG >;
/// @brief Type alias -- notifiable/settable/gettable field
/// @tparam Owner Service element owner
/// @tparam Desc Description information
/// @tparam T Field data type
template < typename Owner, typename Desc, typename T >
using NSomeipNSGField = NSomeipField< Owner, Desc, T, ara::com::internal::proxy::FieldMode::kNSG >;
...
private:
    ...
    /// @brief Set method
    NSomeipRMethod< Owner, ToSetMethodDesc, typename SetMethod::Signature > setMethod_;
};
...
private:
    ...
    /// @brief Get method
    NSomeipRMethod< Owner, ToGetMethodDesc, typename GetMethod::Signature > getMethod_;
};
