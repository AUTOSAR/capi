...
/// @brief      fw deinitialization release client memory
/// @details    fw deinitialization release client memory
/// @date       2025-03-19
/// @author     jzy
/// @version    1.2.0
///
...
/// @unit_description=Initialization processing function
/// @endcode
///
/// ================================================================
///
...
{
    LogError() << "destroy fw client resource.";
    FWClient::GetInstance()->Destroy();
