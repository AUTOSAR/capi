...
// SomeIpFilter::SomeIpFilter(ara::core::Vector< PRuleParse > vecUdpRules,
//                            int const& action,
...
void SomeIpFilter::RulesFilter() noexcept { LogInfo() << "SomeIpFilter::RulesFilter() in!"; }

/// @brief Get rules
void SomeIpFilter::GetRules() noexcept {}
