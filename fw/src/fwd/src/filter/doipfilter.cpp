...
/// ----------------
/// @file       doipfilter.cpp
/// @brief      Firewall application layer DOIP filter class
/// @details    Firewall application layer DOIP filter class
/// @date       2024-12-31
/// @author     jzy
/// @version    1.2.0
///
...
// DoipFilter::DoipFilter(ara::core::Vector< PRuleParse > vecUdpRules,
//                            int const& action,
...
void DoipFilter::RulesFilter() noexcept { LogInfo() << "DoipFilter::RulesFilter() in!"; }

/// @brief Get rules
void DoipFilter::GetRules() noexcept {}
