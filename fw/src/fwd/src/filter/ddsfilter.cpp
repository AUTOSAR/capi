...
/// ----------------
/// @file       ddsfilter.cpp
/// @brief      dds filter processing class
/// @details    dds filter processing class
/// @date       2024-12-31
/// @author     jzy
/// @version    1.2.0
///
...
// DdsFilter::DdsFilter(ara::core::Vector< PRuleParse > vecUdpRules,
//                            int const& action,
...
void DdsFilter::RulesFilter() noexcept { LogInfo() << "DdsFilter::RulesFilter() in!"; }

/// @brief Get rules
void DdsFilter::GetRules() noexcept {}
