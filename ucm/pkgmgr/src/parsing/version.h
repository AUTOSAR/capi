...
public:
    ...
    /// @interface_level=unit
    /// @trace_id_ad=AD_UCM_00000
    /// @trace_id_dd=DD_UCM_10400
    /// @needwork = dda
    /// @endcode
    explicit Version(AraString const& verStr);

    /// @brief constructor
    /// @code{.isoft}
    /// @interface_level=unit
    /// @trace_id_ad=AD_UCM_00000
    /// @trace_id_dd=DD_UCM_10401
    /// @needwork = dda
    /// @endcode
    Version() = default;
    ...
    /// @interface_level=unit
    /// @trace_id_ad=AD_UCM_00000
    /// @trace_id_dd=DD_UCM_10402
    /// @needwork = dda
    /// @endcode
    AraString ToString() const;
