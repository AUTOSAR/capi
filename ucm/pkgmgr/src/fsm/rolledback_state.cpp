...
/// File description:
/// ----------------
/// @file       rolledback_state.cpp
/// @brief      Implementation of RolledBack state class
/// @details
/// @date       2024-08-15
/// @author     cuiyinli
/// @version    1.2.0
...
/// @unit_description=Implementation of RolledBack state class
/// @endcode
///
/// ================================================================
...
/// @throws no
AraFutureVoid RolledBackState::Finish() noexcept
{
