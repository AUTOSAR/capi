...
#ifndef ARA_IAM_CRYPTO_GRANT_QUERY_INTERFACE_H_
#define ARA_IAM_CRYPTO_GRANT_QUERY_INTERFACE_H_
...
namespace internal {
namespace grant {
/// @brief Alias for IAM-Crypto verification
using IAMGrantCryptoQuery = ara::iam::internal::crypto::PIamGrant_Crypto;
}  // namespace grant
}  // namespace internal
}  // namespace iam
}  // namespace ara
