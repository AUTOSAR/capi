...
/// File description:
/// ----------------
/// @file       engine_recovery_action.cpp
...
void EngineRecoveryAction::RecoveryHandler(exec::ExecutionErrorEvent const &executionError,
                                           TypeOfSupervision supervision) noexcept
{
    log_.LogInfo() << "EngineRecoveryAction::RecoveryHandler(), executionError:"
